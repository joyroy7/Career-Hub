...
const Job = ({job}) => {
    ...
    const {logo,job_title,company_name,id,remote_or_onsite,location,salary,job_type}=job;
  ...
  <div className="card-body">
    ...
    <div className="mt-4 flex">
      <h2 className="flex mr-5"><MdLocationOn className="mr-2 text-2xl"></MdLocationOn>{location}</h2>
